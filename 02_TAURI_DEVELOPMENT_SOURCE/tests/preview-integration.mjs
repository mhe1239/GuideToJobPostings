...
assert.match(personalizedListDocument.querySelector("#header-auth-link").textContent, /내 정보/, "로그인한 학생의 상단 메뉴는 내 정보로 표시되어야 합니다.");
...
console.log("preview integration: all checks passed");
